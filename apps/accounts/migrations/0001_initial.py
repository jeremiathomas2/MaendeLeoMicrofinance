    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identification_number', models.CharField(blank=True, max_length=60)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_status', models.CharField(choices=[('ACTIVE', 'Active'), ('LOCKED', 'Locked'), ('DISABLED', 'Disabled'), ('PENDING', 'Pending')], default='ACTIVE', max_length=12)),
